 ...
 */
package org.linepack.emissorboleto.service;
...
import org.linepack.emissorboleto.dao.CedenteDAO;
import org.linepack.emissorboleto.dao.SacadoDAO;
import org.linepack.emissorboleto.dao.SetupDAO;
import org.linepack.emissorboleto.dao.TituloDAO;
import org.linepack.emissorboleto.model.Setup;
import org.linepack.emissorboleto.util.BancoBrasilUtil;
import org.linepack.emissorboleto.util.BancoSicrediUtil;
import org.linepack.emissorboleto.util.StringUtil;
...
public class EmissorBoleto {
    ...
    public byte[] getBoletoBytes(Integer tituloId) {
        org.linepack.emissorboleto.model.Titulo tituloModel = new org.linepack.emissorboleto.model.Titulo();
    ...
    private Boleto getBoletoStream(org.linepack.emissorboleto.model.Titulo tituloModel) {
        try {
            org.linepack.emissorboleto.model.Cedente cedenteModel = this.getCedenteModelById(tituloModel.getCedente().getId());
            org.linepack.emissorboleto.model.Sacado sacadoModel = this.getSacadoModelById(tituloModel.getSacado().getId());

            org.linepack.emissorboleto.model.Sacado sacadorAvalista = null;
    ...
    private org.linepack.emissorboleto.model.Setup getSetupAtivo() {
        SetupDAO setupDAO = new SetupDAO();
        return setupDAO.getByNamedQuery("setupAtivo");
    }

    private org.linepack.emissorboleto.model.Titulo getTituloModelById(Integer id) {
        TituloDAO tituloDAO = new TituloDAO();
        return tituloDAO.getByID(id);
    }

    private org.linepack.emissorboleto.model.Cedente getCedenteModelById(Integer id) {
        CedenteDAO cedenteDAO = new CedenteDAO();
        return cedenteDAO.getByID(id);
    }

    private org.linepack.emissorboleto.model.Sacado getSacadoModelById(Integer id) {
        SacadoDAO sacadoDAO = new SacadoDAO();
        return sacadoDAO.getByID(id);
    }

    private Boleto createBoleto(
            org.linepack.emissorboleto.model.Cedente cedenteModel,
            org.linepack.emissorboleto.model.Sacado sacadoModel,
            org.linepack.emissorboleto.model.Sacado sacadorAvalistaModel,
            org.linepack.emissorboleto.model.Titulo tituloModel) {
    ...
    private Endereco getEnderecoBySacadoModel(org.linepack.emissorboleto.model.Sacado sacado) {
    ...
    private void updateTituloModel(org.linepack.emissorboleto.model.Titulo titulo, Boleto boleto) throws SQLException {
        TituloDAO tituloDAO = new TituloDAO();
